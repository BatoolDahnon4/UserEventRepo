...
namespace MedcorSL.Services
{
    ...
    public class EmailService : IEmailService
    {
        ...
        public Task SendRegistrationEmailAsync(Guest guest, int count, Guid Id)
        {
            ...
            { ToAddress = guest.Email, Subject = "REGISTRATION CONFIRM", Body = @"<p>""هذه دعوة خاصة وشخصية لحضور عشاء التشبيك وبناء العلاقات ويجب إبرازها وقت الحضور""</p> <br> <p>“This is a special and personal invitation for attending the Gala Dinner “Networking Reception”. Make sure to show your invitation when attending the Gala”</p>
              <br> Confirmation Number : " + count, Image = qrData });
        ...
        public Task SendRegistrationEmailAsync(Guid Id,Guest guest)
        {
            ...
            return SendEmailAsync(new EmailViewModel
            { ToAddress = guest.Email, Subject = "REGISTRATION CONFIRM", Body= @"<p>هذه دعوة لحضور فعاليات مؤتمر تكنولوجيا المعلومات والاتصالات ضمن أسبوع فلسطين التكنولوجي - إكسبوتك 2022 ويجب إبرازها وقت الحضور</p> <br> <p>“This is an invitation for attending The ICT Conference within Palestine Technology Week – Expotech 2022. Make sure to show your invitation when attending the conference”</p> ", Image = qrData });
        }
