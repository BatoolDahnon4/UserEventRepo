    ...
    public class EmailService : IEmailService
    {
        ...
        public Task SendRegistrationEmailAsync(Guid Id,Guest guest)
        {
            ...
            { ToAddress = guest.Email, Subject = "REGISTRATION CONFIRM", Body= @"<p>هذه دعوة لحضور فعاليات مؤتمر تكنولوجيا المعلومات والاتصالات ضمن أسبوع فلسطين التكنولوجي - إكسبوتك 2022 ويجب إبرازها وقت الحضور</p>
               <br> <p>“This is an invitation for attending The ICT Conference within Palestine Technology Week – Expotech 2022. Make sure to show your invitation when attending the conference”</p> ", Image = qrData });
        }
